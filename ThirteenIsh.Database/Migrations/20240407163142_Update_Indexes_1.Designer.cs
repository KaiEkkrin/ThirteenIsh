...
namespace ThirteenIsh.Database.Migrations
{
    ...
    [Migration("20240407163142_Update_Indexes_1")]
    partial class Update_Indexes_1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ThirteenIsh.Database.Entities.Adventurer", b =>
                {
                    ...
                    b.OwnsOne("ThirteenIsh.Database.Entities.Variables", "Variables", b1 =>
                        {
                            b1.Property<long>("AdventurerId")
                                .HasColumnType("bigint");
                            ...
                            b1.OwnsMany("ThirteenIsh.Database.Entities.CharacterCounter", "Counters", b2 =>
                                {
                                    b2.Property<long>("VariablesAdventurerId")
                                        .HasColumnType("bigint");
                                    ...
                                    b2.HasKey("VariablesAdventurerId", "Id");

                                    b2.ToTable("Adventurers");

                                    b2.WithOwner()
                                        .HasForeignKey("VariablesAdventurerId");
                                });
                    ...
                    b.OwnsOne("ThirteenIsh.Database.Entities.Variables", "Variables", b1 =>
                        {
                            ...
                            b1.OwnsMany("ThirteenIsh.Database.Entities.CharacterCounter", "Counters", b2 =>
                                {
                                    b2.Property<long>("VariablesEncounterId")
                                        .HasColumnType("bigint");
                                    ...
                                    b2.HasKey("VariablesEncounterId", "Id");

                                    b2.ToTable("Encounters");

                                    b2.WithOwner()
                                        .HasForeignKey("VariablesEncounterId");
                                });
                    ...
                    b.OwnsOne("ThirteenIsh.Database.Entities.Variables", "Variables", b1 =>
                        {
                            ...
                            b1.OwnsMany("ThirteenIsh.Database.Entities.CharacterCounter", "Counters", b2 =>
                                {
                                    b2.Property<long>("VariablesMonsterCombatantId")
                                        .HasColumnType("bigint");
                                    ...
                                    b2.HasKey("VariablesMonsterCombatantId", "Id");

                                    b2.ToTable("Combatants");

                                    b2.WithOwner()
                                        .HasForeignKey("VariablesMonsterCombatantId");
                                });
