...
namespace ThirteenIsh.Database.Migrations
{
    ...
    [Migration("20240411205447_Update_Convert_From_Mongo")]
    partial class Update_Convert_From_Mongo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThirteenIsh.Database.Entities.Combatants.CombatantBase", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("InitiativeRollWorking")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("EncounterId", "Alias")
                        .IsUnique();

                    b.ToTable("Combatants");

                    b.HasDiscriminator<string>("Discriminator").HasValue("CombatantBase");
            ...
            modelBuilder.Entity("ThirteenIsh.Database.Entities.Combatants.AdventurerCombatant", b =>
                {
                    b.HasBaseType("ThirteenIsh.Database.Entities.Combatants.CombatantBase");

                    b.HasDiscriminator().HasValue("AdventurerCombatant");
                });

            modelBuilder.Entity("ThirteenIsh.Database.Entities.Combatants.MonsterCombatant", b =>
                {
                    b.HasBaseType("ThirteenIsh.Database.Entities.Combatants.CombatantBase");
                    ...
                    b.HasDiscriminator().HasValue("MonsterCombatant");
                });
            ...
            modelBuilder.Entity("ThirteenIsh.Database.Entities.Adventurer", b =>
                {
                    ...
                    b.OwnsOne("ThirteenIsh.Database.Entities.CounterSheet", "Variables", b1 =>
                        {
                            b1.Property<long>("AdventurerId")
                                .HasColumnType("bigint");
                            ...
                            b1.OwnsMany("ThirteenIsh.Database.Entities.PropertyValue<int>", "Counters", b2 =>
                                {
                                    b2.Property<long>("CounterSheetAdventurerId")
                                        .HasColumnType("bigint");
                                    ...
                                    b2.HasKey("CounterSheetAdventurerId", "Id");

                                    b2.ToTable("Adventurers");

                                    b2.WithOwner()
                                        .HasForeignKey("CounterSheetAdventurerId");
                                });
            ...
            modelBuilder.Entity("ThirteenIsh.Database.Entities.Combatants.CombatantBase", b =>
                {
                    b.HasOne("ThirteenIsh.Database.Entities.Encounter", "Encounter")
                        .WithMany("Combatants")
            ...
            modelBuilder.Entity("ThirteenIsh.Database.Entities.Encounter", b =>
                {
                    ...
                    b.OwnsOne("ThirteenIsh.Database.Entities.EncounterVariables", "Variables", b1 =>
                        {
                            ...
                            b1.OwnsMany("ThirteenIsh.Database.Entities.CombatantAlias", "TurnOrder", b2 =>
                                {
                                    b2.Property<long>("EncounterVariablesEncounterId")
                                        .HasColumnType("bigint");
                                    ...
                                    b2.HasKey("EncounterVariablesEncounterId", "Id");

                                    b2.ToTable("Encounters");

                                    b2.WithOwner()
                                        .HasForeignKey("EncounterVariablesEncounterId");
                                });
            ...
            modelBuilder.Entity("ThirteenIsh.Database.Entities.Combatants.MonsterCombatant", b =>
                {
                    b.OwnsOne("ThirteenIsh.Database.Entities.CharacterSheet", "Sheet", b1 =>
                        {
                            b1.Property<long>("MonsterCombatantId")
                                .HasColumnType("bigint");
                            ...
                            b1.HasKey("MonsterCombatantId");

                            b1.ToTable("Combatants");

                            b1.ToJson("Sheet");

                            b1.WithOwner()
                                .HasForeignKey("MonsterCombatantId");

                            b1.OwnsMany("ThirteenIsh.Database.Entities.PropertyValue<int>", "Counters", b2 =>
                                {
                                    b2.Property<long>("CharacterSheetMonsterCombatantId")
                                        .HasColumnType("bigint");
                                    ...
                                    b2.Property<uint>("_TableSharingConcurrencyTokenConvention_Version")
                                        .IsConcurrencyToken()
                                        .ValueGeneratedOnAddOrUpdate()
                                        .HasColumnType("xid")
                                        .HasColumnName("xmin");

                                    b2.HasKey("CharacterSheetMonsterCombatantId", "Id");

                                    b2.ToTable("Combatants");

                                    b2.WithOwner()
                                        .HasForeignKey("CharacterSheetMonsterCombatantId");
                                });
                    ...
                    b.OwnsOne("ThirteenIsh.Database.Entities.CounterSheet", "Variables", b1 =>
                        {
                            ...
                            b1.OwnsMany("ThirteenIsh.Database.Entities.PropertyValue<int>", "Counters", b2 =>
                                {
                                    b2.Property<long>("CounterSheetMonsterCombatantId")
                                        .HasColumnType("bigint");
                                    ...
                                    b2.HasKey("CounterSheetMonsterCombatantId", "Id");

                                    b2.ToTable("Combatants");

                                    b2.WithOwner()
                                        .HasForeignKey("CounterSheetMonsterCombatantId");
                                });
