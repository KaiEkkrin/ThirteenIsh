...
namespace ThirteenIsh.Database.Migrations
{
    ...
    [Migration("20240530161839_Add_Tags")]
                    ...
                    b.OwnsOne("ThirteenIsh.Database.Entities.VariablesSheet", "Variables", b1 =>
                        {
                            ...
                            b1.OwnsMany("ThirteenIsh.Database.Entities.PropertyValue<int>", "Counters", b2 =>
                                {
                                    b2.Property<long>("VariablesSheetMonsterCombatantId")
                                        .HasColumnType("bigint");
                                    ...
                                    b2.HasKey("VariablesSheetMonsterCombatantId", "Id");

                                    b2.ToTable("Combatants");

                                    b2.WithOwner()
                                        .HasForeignKey("VariablesSheetMonsterCombatantId");
                                });
