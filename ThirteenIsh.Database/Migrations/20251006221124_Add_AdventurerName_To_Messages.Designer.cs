...
namespace ThirteenIsh.Database.Migrations
{
    ...
    [Migration("20251006221124_Add_AdventurerName_To_Messages")]
    partial class Add_AdventurerName_To_Messages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ThirteenIsh.Database.Entities.Adventurer", b =>
                {
                    ...
                    b.HasIndex("AdventureId", "UserId", "IsDefault")
                        .IsUnique()
            ...
            modelBuilder.Entity("ThirteenIsh.Database.Entities.Messages.LeaveAdventureMessage", b =>
                {
                    ...
                    b.Property<string>("AdventurerName")
                        .HasColumnType("text");
                    ...
                    b.ToTable("Messages", t =>
                        {
                            ...
                            t.Property("AdventurerName")
                                .HasColumnName("ResetAdventurerMessage_AdventurerName");
                        });
